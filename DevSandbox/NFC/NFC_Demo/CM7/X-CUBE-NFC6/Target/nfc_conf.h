...
/* Case of ST25R3916B */
#define PLATFORM_LED_FIELD_PORT      GPIOG    /*!< GPIO port used as field LED                  */
#endif
...
#define NFC08A1_LED1_PIN_PORT        GPIOC
#define NFC08A1_LED1_PIN             GPIO_PIN_0
#define NFC08A1_LED2_PIN_PORT        GPIOC
#define NFC08A1_LED2_PIN             GPIO_PIN_3
#define NFC08A1_LED3_PIN_PORT        GPIOB
#define NFC08A1_LED3_PIN             GPIO_PIN_1

#define NFC08A1_LED1_PIN_CLK_ENABLE()     __HAL_RCC_GPIOC_CLK_ENABLE();
#define NFC08A1_LED2_PIN_CLK_ENABLE()     __HAL_RCC_GPIOC_CLK_ENABLE();
...
#define NFC08A1_LED5_PIN_CLK_ENABLE()     __HAL_RCC_GPIOF_CLK_ENABLE();
#define NFC08A1_LED6_PIN_CLK_ENABLE()     __HAL_RCC_GPIOG_CLK_ENABLE();
#define NFC08A1_LED1_PIN                  GPIO_PIN_0
#define NFC08A1_LED1_PIN_PORT             GPIOC
#define NFC08A1_LED2_PIN                  GPIO_PIN_3
#define NFC08A1_LED2_PIN_PORT             GPIOC
#define NFC08A1_LED3_PIN                  GPIO_PIN_1
#define NFC08A1_LED3_PIN_PORT             GPIOB
#define NFC08A1_LED4_PIN                  GPIO_PIN_2
#define NFC08A1_LED4_PIN_PORT             GPIOC
#define NFC08A1_LED5_PIN                  GPIO_PIN_11
#define NFC08A1_LED5_PIN_PORT             GPIOF
#define NFC08A1_LED6_PIN                  GPIO_PIN_12
#define NFC08A1_LED6_PIN_PORT             GPIOG
...
#define PLATFORM_LED_B_PIN           GPIO_PIN_3         /*!< GPIO pin used for LED B    */
#define PLATFORM_LED_B_PORT          GPIOC    /*!< GPIO port used for LED B   */
#define PLATFORM_LED_F_PIN           GPIO_PIN_0         /*!< GPIO pin used for LED F    */
#define PLATFORM_LED_F_PORT          GPIOC    /*!< GPIO port used for LED F   */
#define PLATFORM_LED_V_PIN           GPIO_PIN_2         /*!< GPIO pin used for LED V    */
...
#define PLATFORM_LED_AP2P_PORT       GPIOF    /*!< GPIO port used for LED AP2P*/

#define BUS_SPI1_NSS_GPIO_PIN           GPIO_PIN_14
#define BUS_SPI1_NSS_GPIO_PORT          GPIOD
#define BUS_SPI1_IRQ_GPIO_PIN           GPIO_PIN_3
...
#define IRQ_ST25R_EXTI_IRQn      EXTI3_IRQn
...
#define USR_INT_LINE             H_EXTI_3
#define USR_INT_LINE_NUM         EXTI_LINE_3
...
extern  EXTI_HandleTypeDef H_EXTI_3;
/* Exported functions ------------------------------------------------------- */
