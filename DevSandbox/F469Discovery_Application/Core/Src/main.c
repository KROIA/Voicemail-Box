...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  //HAL_ADC_PollForConversion(&hadc2, HAL_MAX_DELAY); // Wait for conversion
	  //uint32_t adc_value = HAL_ADC_GetValue(&hadc2);          // Get ADC value
	  //printf("Poti %i\n\r",adc_value);

	  //HAL_ADC_Stop(&hadc2);                          // Stop ADC (optional for single conversion)
    /* USER CODE END WHILE */
    MX_USB_HOST_Process();
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, LED1_Pin|LED1G6_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED0_Pin|LCD_BL_CTRL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED0_Pin LCD_BL_CTRL_Pin */
  GPIO_InitStruct.Pin = LED0_Pin|LCD_BL_CTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
