...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, CODEC_NRESET_Pin|LED1_Pin|LED1G6_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED3_Pin|LED2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, DBG1_Pin|DBG0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DBG2_Pin|LED0_Pin|LCD_BL_CTRL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CODEC_NRESET_Pin LED1_Pin */
  GPIO_InitStruct.Pin = CODEC_NRESET_Pin|LED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : BTN2_Pin uSD_Detect_Pin */
  GPIO_InitStruct.Pin = BTN2_Pin|uSD_Detect_Pin;
  ...
  /*Configure GPIO pins : DBG1_Pin DBG0_Pin */
  GPIO_InitStruct.Pin = DBG1_Pin|DBG0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : LED1G6_Pin */
  GPIO_InitStruct.Pin = LED1G6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED1G6_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : DBG2_Pin LED0_Pin LCD_BL_CTRL_Pin */
  GPIO_InitStruct.Pin = DBG2_Pin|LED0_Pin|LCD_BL_CTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
